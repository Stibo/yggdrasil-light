...
// Set meta data
$this->settings["head"]["meta"]["title"] = "Reisen Title";
$this->settings["head"]["meta"]["description"] = "Reisen Description";
$this->settings["head"]["meta"]["keywords"] = "Reisen Keywords";

?>

<y:section name="content">

	hobbyofotograf -> reisen
